...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
    <a href="http://sivamatta.epizy.com/" class="navbar-brand"> SIVAMATTA.COM</a>
    ...
    <div class="container">
      <div class="row mt-4">
        ...
        <div class="col-sm-8 ">
          ...
          <h1 class="lead">The Complete blog by using PHP by Siva Matta</h1>
          <?php
           echo ErrorMessage();
           echo SuccessMessage();
           ?>
...
<br>
  ...
  <footer class="bg-dark text-white">
    <div class="container">
      <div class="row">
        <div class="col">
          <p class="lead text-center">Theme By | Siva Matta | <span id="year"></span> &copy; ----All right Reserved.
          </p>
          <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;"
              href="https://www.inf.ovgu.de/" target="_blank"> This site is created by ovgu students as skill
              sharing platform</a></p>
        </div>
      </div>
    </div>
  </footer>
